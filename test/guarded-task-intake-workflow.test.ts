    ...
    expect(workflow.jobs.intake.steps.at(-1)).toEqual({
      ...
      env: {
        ...
        GUARDED_TASK_INTAKE_ALLOWED_TARGETS_JSON:
          '[{"repository":"evilstar9527/delivery-loop","baseBranch":"main","environment":"none","allowTestDeploy":false},{"repository":"lightspeed-intelligence/tipsy-backend","baseBranch":"codex/feature/delivery-loop-onboarding-v2","environment":"test","allowTestDeploy":true}]',
