...
- 勾选与遗留：只勾选同一hibernate DoD下“credential安全阶段码本地契约”子证据；真实readiness 200、hibernate、唯一analysis dispatch和heartbeat父项保持未勾。Round 192的历史503不能由新代码反推，当前是该credential blocker恢复审计第2轮。先把本轮代码经受保护PR交付并冻结merged-main bundle；之后owner仍须分别授权exact Worker发布与新的one-shot readiness，任何private-key/Secret/installation修复另行授权，旧run不得rerun。
