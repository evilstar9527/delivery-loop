...
export class InitialAnalysisReconciler {
  ...
  async reconcileBatch(limit = 5): Promise<number> {
    ...
    const sourceSnapshotRecovered = await this.reconcileSourceSnapshotCapacityFailures(finalRemaining);
    const secretValueRemaining = finalRemaining - sourceSnapshotRecovered;
    if (secretValueRemaining === 0) {
      return activated + capacityRecovered + adapterRecovered + sourceSnapshotRecovered;
    }
    ...
    if (scopeRemaining === 0) {
      return activated + capacityRecovered + adapterRecovered + sourceSnapshotRecovered + secretValueRecovered;
    }
    ...
    if (transportRemaining === 0) {
      return activated + capacityRecovered + adapterRecovered + sourceSnapshotRecovered + secretValueRecovered + scopeRecovered;
    }
    ...
    if (providerRemaining === 0) {
      return activated + capacityRecovered + adapterRecovered + sourceSnapshotRecovered + secretValueRecovered + scopeRecovered + transportRecovered;
    }
