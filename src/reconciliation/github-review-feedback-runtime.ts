...
export async function recoverApprovedGitHubReviewFeedbacksFromEnv(
  env: Bindings,
): Promise<unknown[]> {
  return await new GitHubReviewApprovalRecoveryReconciler(env.DB_CONTROL).reconcileBatch(1);
}
